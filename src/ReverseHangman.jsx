...
import hangmanQuestionsLocal from "./data/hangmanQuestions.json";
...
export default function ReverseHangman() {
    ...
    const { data: hangmanQuestions } = useGameQuestions("hangman", hangmanQuestionsLocal, false, "words");
    ...
    const startGame = () => {
        const words = hangmanQuestions.words[difficulty];
                ...
                <main className="rh-main-content">
                    <header className="rh-header">
                        ...
                        <div>
                            <h1 className="rh-title">
                                🛡️ <TranslatedText>{translate.title}</TranslatedText>
                            </h1>
                            <p className="rh-desc"><TranslatedText>{translate.desc}</TranslatedText></p>
                        </div>
                    </header>
                    ...
                    {gameState === 'start' && (
                        <div className="start-screen-rh">
                            ...
                            <h2><TranslatedText>{translate.title}</TranslatedText></h2>
                            <p><TranslatedText>{translate.desc}</TranslatedText></p>

                            <h4 style={{ fontFamily: "'Times New Roman', serif", fontWeight: 700, marginTop: '1rem' }}><TranslatedText>{translate.difficulty}</TranslatedText></h4>
                            ...
                            <button className="start-btn-rh" onClick={startGame}>
                                <TranslatedText>{translate.startGame}</TranslatedText>
                            </button>
                        </div>
                    )}
                        ...
                        <div className="rh-game-container">
                            ...
                            <div className="rh-hud bg-quest-card">
                                ...
                                <div className="rh-hud-lives text-quest-primary">
                                    ...
                                    <span><TranslatedText>Lives</TranslatedText>: {MAX_WRONG_GUESSES - wrongGuesses}</span>
                                </div>
                            </div>
                                    ...
                                    {gameState === 'lost' && (
                                        <div className="rh-overlay rh-overlay-lost">
                                            <div className="rh-overlay-content">
                                                <h3 className="rh-overlay-title-lost"><TranslatedText>{translate.failed}</TranslatedText></h3>
                                                <p className="rh-overlay-text text-quest-text"><TranslatedText>The word was</TranslatedText>: <span className="rh-overlay-word text-quest-primary">{currentWord.word}</span></p>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {gameState === 'won' && (
                                        <div className="rh-overlay rh-overlay-won">
                                            <div className="rh-overlay-content">
                                                ...
                                                <h3 className="rh-overlay-title-won"><TranslatedText>{translate.saved}</TranslatedText></h3>
                                                <p className="rh-overlay-score text-quest-text">+ {score} <TranslatedText>pts</TranslatedText></p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="rh-game-ui bg-quest-card">
                                    ...
                                    <div className="rh-hint-container">
                                        <span className="rh-category-badge text-quest-primary">
                                            <TranslatedText>{currentWord.category}</TranslatedText>
                                        </span>
                                        <p className="rh-hint-text text-quest-text"><TranslatedText>{currentWord.hint}</TranslatedText></p>
                                    </div>
                                    ...
                                    {gameState === 'playing' ? (
                                        ...
                                        <div className="rh-play-again-wrapper">
                                            ...
                                            >
                                                <RotateCcw size={20} />
                                                <TranslatedText>{translate.playAgain}</TranslatedText>
                                            </button>
                                        </div>
                                    )}
                                </div>
