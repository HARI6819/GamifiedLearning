        ...
        <section className="hero">
            ...
            <div className="hero-content">
                ...
                <div className="hero-badge reveal stagger-1">
                    <p>🇮🇳</p>
                    <TranslatedText>{t.home.heroBadge}</TranslatedText>
                </div>

                {/* Heading */}
                <h1 className="hero-title reveal stagger-2">
                    <TranslatedText className="title-primary">{t.home.heroTitle1}</TranslatedText>
                    <br />
                    <TranslatedText className="title-secondary">{t.home.heroTitle2}</TranslatedText>
                </h1>

                {/* Hindi subtitle */}
                <p className="hero-hindi reveal stagger-3"><TranslatedText>{t.home.heroSubtitle}</TranslatedText></p>

                {/* Description */}
                <p className="hero-desc reveal stagger-4"><TranslatedText>{t.home.heroDesc}</TranslatedText></p>

                {/* Buttons */}
                <div className="hero-buttons reveal stagger-5">
                    <button className="btn-primary" onClick={handleStartPlaying}>
                        <Gamepad2 size={20} />
                        <TranslatedText>{t.home.startPlaying}</TranslatedText>
                        <ArrowRight size={20} />
                    </button>
                ...
                <div className="hero-stats reveal stagger-6">
                    <Stat number="3" label={<TranslatedText>{t.home.stats.organs}</TranslatedText>} c="color1" />
                    <Stat number="80+" label={<TranslatedText>{t.home.stats.articles}</TranslatedText>} c="color2" />
                    <Stat number="5+" label={<TranslatedText>{t.home.stats.modes}</TranslatedText>} c="color3" />
                </div>
            </div>
